...
vlog -work work dll_2019_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax dll_2019_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.dll_2019_tb work.glbl
