...
# file: ibert_ultrascale_gth_jb.xdc
####################################################################################
##   ____  ____ 
##  /   /\/   /
## /___/  \  /    Vendor: Xilinx
...
##  /   /         Filename : example_ibert_ultrascale_gth_jb.xdc
## /___/   /\     
## \   \  /  \ 
##  \___\/\___\
##
...
set_property IOSTANDARD  DIFF_SSTL12 [get_ports gth_sysclkp_i]
set_property ODT         RTT_48 [get_ports gth_sysclkp_i]
